    ...
    return (
        <div className='relative bg-no-repeat bg-cover' style={{ backgroundImage: `url(${BackgroundImage})`, height: "100vh", width: "100vw" }}>
            <div className='absolute inset-0 flex justify-center items-center h-screen'>
                <div className='flex w-200  bg-white z-10 rounded-xl shadow-[0_4px_6px_-1px_rgba(0,0,0,0.1),_6px_0_6px_-3px_rgba(0,0,0,0.1),_-6px_0_6px_-3px_rgba(0,0,0,0.1)] ' style={{height: "480px"}}>
                    {/* Left side with form */}
                    <div className='w-2/5 px-2 py-4 ml-8 relative'>
                        <div className='absolute ml-60'>
                            <button 
                                onClick={()=>navigate('/login')} 
                                className='text-gray-700 border border-gray-300 rounded-lg shadow-md text-medium font-medium' style={{width: "80px", height:"40px"}}
                            >
                                Log in
                            </button>
                        </div>
                        ...
                        <form onSubmit={handleSignup} className='flex flex-col space-y-2'>
                            ...
                            <div>
                                <label className='text-gray-700 text-medium font-medium'>Re-type Password</label>
                                <div className='relative'>
                                    <input
                                        type="password"
                                        className='w-full py-1.5 px-2 border border-gray-300 rounded-md text-sm'
                            ...
                            <div className='pt-2'>
                                <button 
                                    type="submit" 
                                    disabled={isLoading}
                                    className='w-full bg-red-500 hover:bg-red-600 text-white text-medium font-medium py-1.5 rounded-full'
                                >
                    ...
                    <div className='w-[350px] mt-10 ml-10 py-2 flex items-center justify-center'>
